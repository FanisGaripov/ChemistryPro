def qualitative_reactions_notorganic(reaction):
    ...
    if are_ions_in_different_substances(
        "Ca", "CO2"
    ) or are_ions_in_different_substances("Ca", "SO4"):
        return "Белый осадок"
    ...
    if are_ions_in_different_substances(
        "Cu", "OH"
    ) or are_ions_in_different_substances("Cu", "S"):
    ...
    if (
        are_ions_in_different_substances("S", "Cu")
        or are_ions_in_different_substances("S", "Pb")
        or are_ions_in_different_substances("S", "Ag")
    ):
    ...
    if are_ions_in_different_substances(
        "SO4", "Ba"
    ) or are_ions_in_different_substances("SO4", "Ag"):
        return "Белый осадок"
